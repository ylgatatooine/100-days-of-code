...
from PomodoroTimer import ORGANIZATION_NAME, APPLICATION_NAME, APP_ICON
from PomodoroTimer.main_window import PomodoroTimerMainWindow
from PomodoroTimer.settings import PomodoroTimerSettings
from PomodoroTimer.timer_proxy import TomatoTimerProxy
from PomodoroTimer.tomato_timer import TomatoTimer
from PomodoroTimer.utils import CommandExecutor, CompactFormatter, makeLogger, addCustomFont
...
def main():
    ...
    app.setDesktopFileName('PomodoroTimer.desktop')

    settings = PomodoroTimerSettings.createQT()
    ...
    watch = PomodoroTimerMainWindow(timerProxy, settings)
